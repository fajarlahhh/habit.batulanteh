...
var handleDatepicker = function () {
    ...
    handleIonRangeSlider = function () {
        $("#default_rangeSlider").ionRangeSlider({ min: 0, max: 5e3, type: "double", prefix: "$", maxPostfix: "+", prettify: !1, hasGrid: !0 }),
            $("#customRange_rangeSlider").ionRangeSlider({ min: 1e3, max: 1e5, from: 3e4, to: 9e4, type: "double", step: 500, postfix: " €", hasGrid: !0 }),
            $("#customValue_rangeSlider").ionRangeSlider({ values: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], type: "single", hasGrid: !0 });
    },
    ...
    handleDateRangePicker = function () {
        $("#default-daterange").daterangepicker({ opens: "right", format: "MM/DD/YYYY", separator: " to ", startDate: moment().subtract("days", 29), endDate: moment(), minDate: "01/01/2012", maxDate: "12/31/2018" }, function (e, t) {
    ...
    handleBootstrapColorPalette = function () {
        ...
        $("#color-palette-custom")
            .colorPalette({ colors: [["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#EFF7F7", "#FFFFFF"]] })
            .on("selectColor", function (e) {
    ...
    handleSimpleColorpicker = function () {
        $('select[name="jquery-simplecolorpicker"]').simplecolorpicker("selectColor", "#2d353c"),
            ...
            $('select[name="colorpicker-picker-longlist"]').simplecolorpicker({ picker: !0, theme: "glyphicons" });
    },
    handleClipboard = function () {
        new ClipboardJS(".btn").on("success", function (t) {
            $(t.trigger).tooltip({ title: "Copied", placement: "top" }),
                $(t.trigger).tooltip("show"),
                setTimeout(function () {
