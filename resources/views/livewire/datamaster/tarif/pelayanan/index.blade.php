<div>
    @section('title', 'Pelayanan/Sangsi')

    @section('page')
        <li class="breadcrumb-item">Data Master</li>
        <li class="breadcrumb-item">Tarif</li>
        <li class="breadcrumb-item active">Pelayanan/Sangsi</li>
    @endsection

    <h1 class="page-header">Pelayanan/Sangsi</h1>
                ...
                <div class="col-xl-1 col-sm-1">
                    @role('administrator|super-admin')
                        <div class="form-inline">
                            <a class="btn btn-primary" href="{{ route('datamaster.tarif.pelayanan.tambah') }}">Tambah</a>
                        </div>
                    @endrole
                </div>
                                ...
                                <td class="with-btn-group align-middle text-right" nowrap>
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="{{ route('datamaster.tarif.pelayanan.edit', ['key' => $row->getKey()]) }}"
