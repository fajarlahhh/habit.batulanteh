<div>
    @section('title', 'Meter Air')

    @section('page')
        <li class="breadcrumb-item">Data Master</li>
        <li class="breadcrumb-item">Tarif</li>
        <li class="breadcrumb-item active">Meter Air</li>
    @endsection

    <h1 class="page-header">Meter Air</h1>
                ...
                <div class="col-xl-1 col-sm-1">
                    @role('super-admin|supervisor')
                        <div class="form-inline">
                            <a class="btn btn-primary" href="{{ route('datamaster.tarif.meterair.tambah') }}">Tambah</a>
                        </div>
                    @endrole
                </div>
                    ...
                    @foreach ($data as $i => $row)
                        <tr>
                            ...
                            <td class="align-middle">
                                <ul>
                                    @foreach ($row->tarifMeterAirDetail as $subRow)
                                        <li>
                                            {{ $subRow->jenis . ' = ' . number_format($subRow->nilai) }}
                                        </li>
                                    @endforeach
                                </ul>
                            </td>
                                ...
                                <td class="with-btn-group align-middle text-right" nowrap>
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="{{ route('datamaster.tarif.meterair.edit', ['key' => $row->getKey()]) }}"
