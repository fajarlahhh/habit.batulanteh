<div>
    ...
    <h1 class="page-header">Materai</h1>
                ...
                <div class="col-xl-1 col-sm-1">
                    @role('super-admin|supervisor')
                        <div class="form-inline">
                            <a class="btn btn-primary" href="{{ route('datamaster.tarif.materai.tambah') }}">Tambah</a>
                        </div>
                    @endrole
                </div>
                                ...
                                <td class="with-btn-group align-middle text-right" nowrap>
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="{{ route('datamaster.tarif.materai.edit', ['key' => $row->getKey()]) }}"
