<div>
    ...
    @section('page')
        ...
        <li class="breadcrumb-item active">Diameter</li>
    @endsection

    <h1 class="page-header">Diameter</h1>
                ...
                <div class="col-xl-1 col-sm-1">
                    @role('administrator|super-admin')
                        <div class="form-inline">
                            <a class="btn btn-primary" href="{{ route('datamaster.diameter.tambah') }}">Tambah</a>
                        </div>
                    @endrole
                </div>
                                ...
                                <td class="with-btn-group align-middle text-right" nowrap>
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        @else
                                            ...
                                            @else
                                                <a href="{{ route('datamaster.diameter.edit', ['key' => $row->getKey()]) }}"
