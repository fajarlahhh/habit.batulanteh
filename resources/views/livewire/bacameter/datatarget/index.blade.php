        ...
        <div class="col-xl-10 col-sm-10">
          <div class="form-inline pull-right">
            <div class="form-group">
              <select class="form-control selectpicker" wire:model="terbaca" data-style="btn-info" data-width="100%">
                <option value="1">BELUM BACA</option>
                <option value="2">SUDAH BACA</option>
              </select>
            </div>&nbsp;
            <div class="form-group">
              <select class="form-control selectpicker" wire:model="bulan" data-live-search="true" data-style="btn-info"
                data-width="100%">
                @for ($m = 1; $m <= 12; $m++)
            ...
            <div class="form-group">
              <select class="form-control selectpicker" wire:model="tahun" data-live-search="true" data-style="btn-info"
                data-width="100%">
            ...
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Cari" aria-label="Sizing example input"
      ...
      <ul class="nav m-t-10">
        <li class="nav-widget text-white">
          @if ($terbaca == 2)
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="date" class="form-control form-control" min="{{ $tahun . '-' . $bulan . '-01' }}"
                  max="{{ date('Y-m-t', strtotime($tahun . '-' . $bulan . '-01')) }}" wire:model.lazy="tanggalBaca" />
              </div>
            </div>
          @endif
          <div class="form-group">
            <label class="control-label">Unit Pelayanan</label>
            <select class="form-control selectpicker" wire:model="unitPelayanan" data-container="#sidebar-right"
        ...
        \App\Models\Regional::where('unit_pelayanan_id', $unitPelayanan)->get()->pluck('id'),
          ...
          <div class="form-group">
            ...
            <select class="form-control selectpicker" wire:model="pembaca" data-container="#sidebar-right"
              data-live-search="true" data-size="10" data-width="100%">
              <option value="">SEMUA PEMBACA</option>
              @foreach ($dataPembaca as $row)
          ...
          @if ($terbaca == 2)
            <div class="form-group">
              ...
              <select class="form-control selectpicker" wire:model="statusBaca" data-container="#sidebar-right"
                data-live-search="true" data-size="10" data-width="100%">
            ...
            <div class="form-group">
              ...
              <select class="form-control selectpicker" wire:model="pemakaian" data-container="#sidebar-right"
                data-live-search="true" data-size="10" data-width="100%">
