<div>
    <div>
        @section('title', 'Progres Baca Meter')

        @section('page')
            <li class="breadcrumb-item">Cetak</li>
            <li class="breadcrumb-item active">Progres Baca Meter</li>
        @endsection

        <h1 class="page-header">Progres Baca Meter</h1>
        ...
        fn($q) => $q->whereIn(
            ...
            <div class="panel-body table-responsive">
                @include('cetak.progresbacameter')
            </div>
        </div>
