                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" style="width: 100%;" data-live-search="true"
                                ...
                                @foreach (\App\Models\Pelanggan::when(auth()->user()->unit_pelayanan_id, fn ($q) => $q->whereIn('rayon_id', \App\Models\Regional::where('unit_pelayanan_id', auth()->user()->unit_pelayanan_id)->whereIn('status', [1,2])->get()->pluck('id')))->get() as $row)
