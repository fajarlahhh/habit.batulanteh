<div>
    ...
    @section('page')
        ...
        <li class="breadcrumb-item active">Angsuran Rekening Air</li>
    @endsection

    <h1 class="page-header">Data Pembayaran <small>Angsuran Rekening Air</small></h1>
                ...
                <tbody>
                    @foreach ($data as $index => $row)
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-nowrap">{{ $row->angsuranRekeningAir->nomor }}</td>
                            <td class="align-middle">{{ $row->angsuranRekeningAir->pelanggan->no_langganan }}</td>
                            <td class="align-middle">{{ $row->angsuranRekeningAir->pelanggan->nama }}</td>
                            <td class="align-middle">{{ $row->angsuranRekeningAir->pelanggan->alamat }}</td>
                            <td class="align-middle">{{ $row->urutan }}</td>
