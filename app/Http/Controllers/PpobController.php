            ...
            if ($pengguna->count() > 0) {
                ...
                return response()->json([
                    ...
                    'data' => RekeningAir::with('golongan')->with('pelanggan')->where('kasir', $pengguna->nama)->whereBetween('waktu_bayar', [$tanggal[0] . ' 00:00:00', $tanggal[1] . ' 23:59:59'])->get()->map(fn ($q) => [
                        ...
                        'biaya_meter_air' => (int) $q->biaya_meter_air,
                        'biaya_admin' => (int)$q->biaya_admin,
                        'biaya_materai' => (int)$q->biaya_materai,
                        'biaya_denda' => (int)$q->biaya_denda,
                        "jumlah" => (int)$q->harga_air + $q->biaya_lainnya + $q->biaya_meter_air + $q->biaya_admin + $q->biaya_materai + $q->biaya_denda,
                    ]),
                ]);
            }
            return response()->json([
